...
export default function Hero() {
  return (
    <section id="top" className="relative overflow-hidden pb-16 pt-28 lg:pt-[150px]">
      <div className="container-page grid grid-cols-1 items-start gap-12 lg:grid-cols-[minmax(0,1fr)_480px] lg:gap-0">

        {/* ---------- COLUNA ESQUERDA ---------- */}
        <div>
          {/* Figma: 244 x 28 */}
          <span className="inline-flex h-7 items-center gap-2 rounded-full bg-white pl-1 pr-4
                           text-[12px] font-medium text-ink
                           shadow-[0_10px_26px_-16px_rgba(2,45,87,0.18)] ring-1 ring-ink/[0.05]">
            <span className="grid h-5 w-5 place-items-center rounded-[7px]
                             bg-gradient-to-br from-[#FDE7ED] via-white to-[#F4DEE6] ring-1 ring-rose-100">
              <svg width="14" height="14" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.38593 4.05259L12.0866 1.90091V16.7914C7.3001 14.8058 5.38593 11.0005 5.38593 8.85031V4.05259ZM18.7874 4.05259L12.0866 1.90091V16.7914C16.8732 14.8058 18.7874 11.0005 18.7874 8.85031V4.05259Z" fill="url(#badgeGrad)"/>
                <defs>
                  <linearGradient id="badgeGrad" x1="12.0866" y1="1.90091" x2="12.0866" y2="16.7914" gradientUnits="userSpaceOnUse">
